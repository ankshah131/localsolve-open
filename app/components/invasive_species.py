...
class InvasivesMap:
    ...
    def display(self):
        ...
        # Changed from 2 columns to a tab-based layout
        ...
        with tabs[0]:
            with st.spinner("Loading map... This may take a few moments..."):
                ...
                if m is not None:
                    ...
                    folium_static(m, width=1323, height=600)
        ...
        with tabs[1]:
            ...
            # Creating expandable sections for each species to save space
            species_info = [
            ...
            for i, (name, description, img_url) in enumerate(species_info):
